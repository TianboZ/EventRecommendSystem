...
public class TicketMasterAPI implements ExternalAPI {
	...
	public List<Item> search(double lat, double lon, String term) {  
		...
		// "http://app.ticketmaster.com/discovery/v2/events.json?apikey=12345&geoPoint=abcd&keyword=music&radius=50"
		...
		try {
			...
			// response code should be 200, otherwise, then connection is failed, just help to debug
	...
	// only search() will use this method
	private String urlEncodeHelper(String url) {
		try {
			// e.g. " " to "20%" 空格是invalid， 我们要替换成20%
